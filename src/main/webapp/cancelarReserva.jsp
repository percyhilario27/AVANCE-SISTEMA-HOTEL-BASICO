...
<html lang="es">
    <head>
        ...
        <style>
            ...
            .badge-CONFIRMADA { background: #e6f4ea; color: #2e7d32; }
            .badge-PENDIENTE  { background: #fff8e1; color: #f57f17; }
            .badge-CANCELADA  { background: #fdecea; color: #c62828; }
            .ver-detalles {
                font-size: 13px;
                background: none;
                border: none;
    ...
    <body>
        ...
        <div class="page">
            ...
            <div class="reservas-lista">
                ...
                <% } else {
                    boolean tieneActivas = false;
                    for (reservaModel r : reservas) {
                        // FILTRO: Solo mostramos las reservas que NO estén canceladas
                ...
                <div class="card">
                    ...
                    <div class="card-body">
                        ...
                        <div class="card-footer">
                            ...
                            <%-- Formulario seguro para enviar el ID al Controlador --%>
                            <form action="${pageContext.request.contextPath}/reservaServlet" method="POST" onsubmit="return confirm('¿Estás seguro de que deseas cancelar la reserva #RES-<%= r.getIdReserva() %>? Esta acción es irreversible.');" style="margin: 0;">
                                <input type="hidden" name="accion" value="cancelarReserva">
                                <input type="hidden" name="idReserva" value="<%= r.getIdReserva() %>">
                                
                                <button type="submit" class="ver-detalles" style="color: #c62828; font-weight: bold;">
                                    Cancelar Reserva &#10006;
                                </button>
                            </form>
                        </div>
                ...
                <%      } 
                    ...
                    // Si el bucle terminó y todas las reservas estaban canceladas, mostramos el mensaje vacío
                    if (!tieneActivas) { %>
                        <div class="empty">
